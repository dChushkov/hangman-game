...
if(isset($_POST['selectCategory'])){
    echo "Select Category form submitted!";
...
function getRating()
{
    if (isset($_SESSION['correctGuesses']) && isset($_SESSION['incorrectGuesses'])) {
        ...
        // Check if $totalGuesses is greater than 0 to avoid division by zero
        if ($totalGuesses > 0) {
...
function setUpGame(){
    ...
    switch ($category) {
        case "fruits":
            ...
            setCategoryIcon("fa-apple-whole");
            break;
        case "vegetables":
